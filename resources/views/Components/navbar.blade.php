<header class="bg-brand-light sticky top-0 z-50 shadow-sm">
    <div class="container mx-auto px-4 md:px-6 py-4 flex justify-between items-center">
        <a href="/" class="flex items-center gap-3 cursor-pointer">
            <div class="bg-brand-primary text-white p-2 md:p-3 rounded-lg flex flex-col justify-center items-center">
                <h1 class="font-heading font-bold text-lg md:text-xl leading-none tracking-wider">ANANDA</h1>
                <span class="text-[8px] md:text-[10px] uppercase tracking-widest mt-1">Bakery</span>
            </div>
        </a>
        
        <nav class="hidden md:flex gap-8 font-medium text-sm tracking-wide items-center">
            ...
            <a href="/b2b" class="border-b-2 transition duration-300 py-1 {{ request()->is('b2b') ? 'text-brand-primary border-brand-primary' : 'text-brand-dark border-transparent hover:text-brand-primary hover:border-brand-primary' }}">
                B2B
            </a>
        </nav>
        ...
        <div class="flex items-center gap-4 md:gap-6">
            ...
            <button aria-label="Cart" class="relative hover:text-brand-primary transition duration-300">
                <i class="fa-solid fa-cart-shopping text-lg md:text-xl"></i>
                <span class="absolute -top-2 -right-2 bg-brand-primary text-white text-[10px] md:text-xs font-bold w-4 h-4 md:w-5 md:h-5 rounded-full flex items-center justify-center">0</span>
            </button>
            <button class="hidden md:block bg-brand-primary hover:bg-brand-dark text-white text-sm font-semibold py-2 px-6 rounded-full transition duration-300 shadow-md whitespace-nowrap">
                LOGIN/SIGN UP
            </button>
    ...
    <div id="mobile-menu" class="hidden md:hidden bg-white border-t border-gray-100 shadow-inner absolute w-full left-0">
        <div class="flex flex-col px-4 py-4 space-y-4 font-medium text-sm">
            ...
            <a href="/b2b" class="block transition {{ request()->is('b2b') ? 'text-brand-primary font-bold' : 'text-brand-dark hover:text-brand-primary' }}">B2B</a>
